  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 md:space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        ...
        <section className="md:col-span-1 bg-slate-900/40 border border-slate-800 rounded-xl p-4 md:p-5 flex flex-col h-[350px]">
          ...
          <div className="space-y-4 overflow-y-auto pr-2 pb-2 flex-1 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent">
            {data.recentActivity.slice(0, 6).map((activity) => (
              <div key={activity.id} className="flex justify-between items-center border-b border-slate-800 pb-3 last:border-0 last:pb-0">
                <div>
